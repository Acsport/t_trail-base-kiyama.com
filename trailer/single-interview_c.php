	    ...
	    <div class="sec01 fadeInTrigger">
	      <div class="content">
	        <div class="topBox clearfix fadeInTrigger">
	          <h2>Voice</h2>
	          <div class="imgTxtBox">お客様の声（法人向け）</div>
            </div>
          </div>
        </div>
...
<?php
          $post_type_slug = 'interview_c';
          $tax_terms = get_terms($tax_name);
        ?> 
	          <h3 class="headLine00 fadeInTrigger">
              <span class="en ttl_green">For Corporate</span>
...
<div class="pager_wrap">
 ...
    <a class="post_archive" href="<?php echo esc_url(home_url()); ?>/office_use/#voice">お客様の声<br />（法人向け）</a>
</div><!--/.pager_container-->
<!-- pagerここまで -->
